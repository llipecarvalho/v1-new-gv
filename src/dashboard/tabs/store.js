...
export default {
    render: (state) => {
        ...
        <div id="tab-store" class="tab-pane animate-fade space-y-6 px-6 pb-48">
            ...
            <!-- Alternador Principal: Loja vs Resgates -->
            <div class="bg-[#1a1a1a] p-1 rounded-2xl flex items-center mb-6 relative border border-white/5">
                <button id="btn-store-shop" class="flex-1 py-3 rounded-xl bg-[#f085aa] text-black text-[10px] font-black uppercase transition-all z-10">Loja</button>
                <button id="btn-store-history" class="flex-1 py-3 rounded-xl text-gray-500 text-[10px] font-black uppercase transition-all z-10">Meus Resgates</button>
            </div>
